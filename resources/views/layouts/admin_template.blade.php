...
<head>
    ...
    <title>Продавайк@ - Панель управления</title>
        ...
        <div class="header-btn">
            ...
            <div class="profile">
                ...
                <ul class="profile-submenu">
                    <li><a href="{{ route('myaccount.ad.index') }}">Пользователи</a></li>
                    <li><a href="{{ route('admin.category.index') }}">Категории</a></li>
                    <li><a href="{{ route('adminHome') }}">Все объявления</a></li>
                    <li><a href="{{ route('myaccount.ad.index') }}">Ваши объявления</a></li>
                    <li><a href="{{ route('myaccount.ad.create') }}">Создать объявление</a></li>
